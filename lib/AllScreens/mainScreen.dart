...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin {
  ...
  DirectionDetails tripDirectiondetails = DirectionDetails(distanceValue: 0,
      durationValue: 0,
      distanceText: '',
      durationText: '',
      encodedPoints: '');
                            ...
                            children: [
                              Text(
                                Provider
                                    ...
                                    : "Add Home", style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 17.0,
                                  fontFamily: "Brand-Bold"),),
                              SizedBox(height: 4.0,),
                              Text("Your living home adress", style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Image.asset(
                                "images/taxi.png", height: 70.0, width: 80.0,),
                              SizedBox(width: 16.0,),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      width: double.infinity,
                      child: ColorizeAnimatedTextKit( //animated kitten daha güzelini bul
                        onTap: () {
                          print("Tap Event");
                        },
                        text: [
